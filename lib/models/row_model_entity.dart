...
List<RowModel> rowModelFromJson(String str) => List<RowModel>.from(json.decode(str).map((x) => RowModel.fromJson(x)));

String rowModelToJson(List<RowModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
