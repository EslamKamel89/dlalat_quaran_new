...
class ArticleDetailsScreen extends StatelessWidget {
  ...
  ArticleDetailsScreen({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: Obx(()=> Text(
                ...
                style: const TextStyle(
                    ...
                    color: primaryColor, fontSize: 18, fontFamily: 'Almarai'),
              )),
            ),
            Expanded(
                child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ElevatedButton(
                          onPressed: () =>   _detailsController.updateArticleModel(
                              _detailsController.relatedArticles[index]),
                          child: Text(
