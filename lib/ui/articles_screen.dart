import 'package:dlalat_quran/controllers/articles_controller.dart';
import 'package:dlalat_quran/widgets/articles_widgets.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Obx(()=> _articlesController.filteredList.isNotEmpty?  Expanded(
              child: ListView.builder(
                itemBuilder: (context, index) {
                  return ArticlesWidget(_articlesController.filteredList[index]);
                },
                itemCount: _articlesController.filteredList.length,
              )): Expanded(child: Center(child: Text('no_articles_found'.tr,textAlign: TextAlign.center,))))
        ],
      ),
    );
  }
