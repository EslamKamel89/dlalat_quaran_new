...
class SelectRecitationsDialog extends StatelessWidget {
  ...
  SelectRecitationsDialog(this.playerBottomController, {Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Obx(() => settingsController
                              .recitersList.isEmpty
                          ? const SizedBox()
                          : ListView.separated(
                              itemCount:
                                  settingsController.recitersList.length,
